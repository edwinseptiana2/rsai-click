...
export const pages = mysqlTable(
  "pages",
  {
    ...
    textColor: varchar("text_color", { length: 50 }).default("default"),
  titleColor: varchar("title_color", { length: 50 }).default("default"),
  bioColor: varchar("bio_color", { length: 50 }).default("default"),
